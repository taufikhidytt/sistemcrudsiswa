...
<section class="content">
    ...
    <div class="card-body">
        ...
        <a href="<?= base_url('siswa/add')?>" class="btn btn-success btn-sm">
        ...
        <table class="table table-bordered table-hover text-center" id="barang">
            ...
            <tbody>
                <?php $no=1; $total=0; foreach($siswa->result() as $data):?>
                <tr>
                    <td><?= $no++;?></td>
                    <td><?= $data->nik;?></td>
                    <td><?= $data->nama;?></td>
                    ...
                    <td>
                        <a href="<?= base_url('siswa/ubah/'.$data->id_siswa)?>" class="btn btn-primary btn-sm">
                            <i class="fa fa-pencil-alt"></i>
                        </a>    |
                        <form action="<?= base_url('siswa/del')?>" method="post" class="d-inline">
